...
namespace Billionaires.Helpers.Tiles
{
    ...
    public class CRC32
    {
        private readonly UInt32[] _crcTable = {
        ...
        private UInt32 _crcValue = (UInt32)0xffffffffL;
...
*/
        ...
        public UInt32 CRC()
        {
            return _crcValue ^ (UInt32)0xffffffffL;
        }
...
*/
        ...
        /// <param name="len">The length of the byte[].</param>
        /// <param name="offset">The offset to start processing byte[] at.</param>
        public void AddToCRC(byte[] buf, int len, UInt32 offset = 0)
        {
            UInt32 n;
            UInt32 c = _crcValue;
...
*/
    ...
    public class Adler32
    {
        ...
        private UInt32 _adlerA = 1;
        private UInt32 _adlerB;
...
*/
        ...
        public void AddToAdler(byte[] data, int len, UInt32 offset)
        {
            ...
            for (index = offset; index < offset + len; index++)
            {
                _adlerA = (_adlerA + data[index]) % ModAdler;
